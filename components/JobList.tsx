...
const JobList: React.FC<JobListProps> = ({ jobs, initialLoad, sources }) => {
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-lg p-4">
        ...
        {sources && sources.length > 0 && (
          <div className="mb-4 text-xs text-gray-500 border-t pt-3 mt-3">
            <p className="font-semibold text-gray-600">Data Sourced From:</p>
